        ...
        <div class="flex flex-wrap -mx-3 mb-10 items-end bg-white pt-2">
          <div class="w-1/2 px-3">
            ...
            <select
              ...
              class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 mt-2"
