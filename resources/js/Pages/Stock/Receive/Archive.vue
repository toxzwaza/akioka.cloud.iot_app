          ...
          <div class="card overflow-hidden">
            <div class="overflow-x-auto">
              <table class="table-modern">
                ...
                <tbody>
                  <tr v-for="order in initial_orders" :key="order.id" :class="{'bg-red-50': order.not_found_flg}">
                    <td>
                      <span
                        class="underline text-primary-600 cursor-pointer hover:text-primary-700 font-medium"
