        ...
        <div class="flex justify-between items-start">
                        ...
                        <tbody>
                            ...
                            >
                                <td class="px-6 py-4 order_name">
                                    ...
                                    <span v-if="order.duty_flg" class='duty_user inline-flex items-center bg-red-50 text-red-600 text-xs font-medium mr-2 pl-2 pr-2.5 rounded-full py-1'>
                                        <span class='w-1 h-1 mr-1 rounded-full bg-red-400 flex'></span>ポット登板 </span>
            ...
            <div id="right_container" class="w-2/3 py-8 pl-8">
                <div id="system_msg" class="font-bold text-2xl mb-4">
                    <h3 v-if="time_flg == 'order'" class="text-blue-500">弁当注文時間内です。</h3>
                ...
                <div v-else class="content">
                    <h1
                        class="text-center font-bold text-8xl text-blue-500 mt-16"
                    >
                        {{ form.user_name }}
                    </h1>
                    <div
